...
@OnlyIn(Dist.CLIENT)
public class CognigolemModel<T extends CognigolemEntity> extends SegmentedModel<T> {
    ...
    public void setupAnim(T cognigolemEntity, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
    ...
    public void prepareMobModel(T cognigolemEntity, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        int i = 0; //cognigolemEntity.getAttackAnimationTick();
        if (i > 0) {
            ...
            int j = 0; //cognigolemEntity.getOfferFlowerTick();
            if (j > 0) {
